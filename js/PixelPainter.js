...
//THIS IS THE BLANK GRID
  ...
  $('.palette-cell').click(function() {                  //initiates the event handler with a click on the color pallette
    clickedColor = $(this).css('background-color');//this holds the color of the clicked tile in variable clickedColor
    });

  $('.grid-cell').click(function(){                //initiates event handler with a click on grid cell
